...
import {
  ...
  OperatorResponse,
  OwnershipForString,
} from "./Cw721MetadataOnchain.types";
export interface Cw721MetadataOnchainReadOnlyInterface {
  ...
  allTokens: ({ limit, startAfter }: { limit?: number; startAfter?: string }) => Promise<TokensResponse>;
...
export class Cw721MetadataOnchainQueryClient implements Cw721MetadataOnchainReadOnlyInterface {
  ...
  allTokens = async ({ limit, startAfter }: { limit?: number; startAfter?: string }): Promise<TokensResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      all_tokens: {
        limit,
        start_after: startAfter,
...
export class Cw721MetadataOnchainClient
  extends Cw721MetadataOnchainQueryClient
  implements Cw721MetadataOnchainInterface
{
